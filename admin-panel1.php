...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Manipal Hospital </a>
...
.btn-primary{
  ...
  <div class="col-md-8" style="margin-top: 3%;">
               ...
               <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;">Doctor </h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: -3%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >  </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Patient </h4>
                ...
                <div class="col-sm-4">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Appointment</h4>
                ...
                <div class="col-sm-4" style="left: 13%;margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">  </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Prescription</h4>
                ...
                <div class="col-sm-4" style="left: 18%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x">  </span>
                      <h4 class="StepTitle" style="margin-top: 5%;">Manage </h4>
    ...
    <div class="tab-pane fade" id="list-pat" role="tabpanel" aria-labelledby="list-pat-list">
      ...
      <div class="col-md-8">
      <form class="form-group" action="med.php" method="post">
        <div class="row">
        <div class="col-md-10"><input type="text" name="medcinid" placeholder="Enter medicine id" class = "form-control"></div>
        <div class="col-md-2"><input type="submit" name="medicineidsubmit" class="btn btn-primary" value="Search"></div></div>
      </form>
    </div>
              <table class="table table-hover">
                <thead>
